          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="text-accent-400">Breaking News</span>
              </h1>
              <p className="text-xl md:text-2xl text-primary-100 max-w-4xl mx-auto leading-relaxed">
                NewsHubPro delivers comprehensive coverage of global events with
                unbiased reporting, in-depth analysis, and expert commentary
                across politics, business, entertainment, sports, technology,
                and health.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-primary-200">
                  Get breaking news as it happens with our 24/7 monitoring and
              ...
              <div className="text-center">
                ...
                <p className="text-primary-200">
                  Comprehensive international news coverage with local insights
                  and expert analysis.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-primary-200">
                  Verified facts, multiple sources, and unbiased reporting you
                  can trust for informed decisions.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  ...
                  NewsHubPro stands out as your premier destination for reliable
                  news coverage, offering comprehensive reporting across all
                  major categories including politics, business, entertainment,
                  sports, technology, and health news.
                </p>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Our experienced team of journalists and editors work around
                  the clock to bring you accurate, timely, and unbiased news
                  coverage. We verify every story through multiple sources and
                  provide the context you need to understand complex global
                  events.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                From breaking political developments to the latest in technology
                and entertainment, NewsHubPro covers the stories that matter
                most to you.
              </p>
            </div>
